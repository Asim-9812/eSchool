          ...
          Center(
            child: Column(
              children: [
                ...
                Text('Parent Profile',style : TextStyle(fontSize: 25.sp,color: Colors.white)),
                SizedBox(
                  height: 55.h,
                ),
                Container(
                              ...
                              child: ListTile(
                                ...
                                title: Column(
                                  ...
                                  children: [
                                    ...
                                    Text('Parent\'s Name:',style:TextStyle(color: Colors.grey,fontSize: 15.sp)),
                                    SizedBox(
                                      height: 5.h,
                                    ),
                                    ...
                                    Text('-',style:TextStyle(color: Colors.grey,fontSize: 15.sp)),
                                    SizedBox(
                                      height: 5.h,
                                    ),
                                    Text('-',style:TextStyle(color: Colors.black,fontWeight: FontWeight.bold)),
